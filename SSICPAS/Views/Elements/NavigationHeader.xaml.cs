...
namespace SSICPAS.Views.Elements
{
    ...
    public partial class NavigationHeader : Grid
    {
        ...
        protected override void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            ...
            else if(propertyName == CenterImageAccessibilityTextProperty.PropertyName)
            {
                AutomationProperties.SetHelpText(CenterImage, CenterImageAccessibilityText);
                AutomationProperties.SetIsInAccessibleTree(CenterImage, !string.IsNullOrEmpty(CenterImageAccessibilityText));
            }
        ...
        public static readonly BindableProperty CenterImageAccessibilityTextProperty =
            BindableProperty.Create(nameof(CenterImageAccessibilityText), typeof(string), typeof(Image), string.Empty, BindingMode.OneWay);

        public string CenterImageAccessibilityText
        {
            get { return (string)GetValue(CenterImageAccessibilityTextProperty); }
            set { SetValue(CenterImageAccessibilityTextProperty, value); }
        }

...
{
    public partial class InfoVaccineTextView : ContentView
    {

        public InfoVaccineTextView()
        {
            InitializeComponent();
            Content.BindingContext = new InfoVaccineTextViewModel();
        }
        ...
        public static readonly BindableProperty OnlyOneEUPassportProperty =
            BindableProperty.Create(nameof(OnlyOneEUPassportBool), typeof(bool), typeof(InfoVaccineTextView), null,
                BindingMode.OneWay);
        ...
        protected override void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            ...
            if (propertyName == PassportViewModelProperty.PropertyName)
            {
                ...
                {
                    (Content.BindingContext as InfoVaccineTextViewModel).PassportViewModel = PassportViewModel;
                    (Content.BindingContext as InfoVaccineTextViewModel).UpdateView();
                }
                
            }
            if (propertyName == ShowCertificateProperty.PropertyName)
            {
                (Content.BindingContext as InfoVaccineTextViewModel).ShowCertificate = ShowCertificateBool;
            }
            if (propertyName == ShowHeaderProperty.PropertyName)
            {
                (Content.BindingContext as InfoVaccineTextViewModel).ShowHeader = ShowHeaderBool;
            }
            if (propertyName == ShowTextInEnglishProperty.PropertyName)
            {
                (Content.BindingContext as InfoVaccineTextViewModel).ShowTextInEnglish = ShowTextInEnglishBool;
            }
            if (propertyName == OnlyOneEUPassportProperty.PropertyName)
            {
                (Content.BindingContext as InfoVaccineTextViewModel).OnlyOneEUPassport = OnlyOneEUPassportBool;
            }

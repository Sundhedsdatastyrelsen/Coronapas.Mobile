...
namespace SSICPAS.Droid.Services.ImagerService
{
    public class ZebraTechnologyScanner : IImagerScanner
    {
        ...
        private static string EXTRA_PROFILE_NAME = "SSICPASS_DW_PROFILE";
        ...
        public void SetConfig(IScannerConfig a_config)
        {
            ...
            profileConfig.PutString("PROFILE_ENABLED", _bRegistered ? "true" : "false");
            ...
            barcodeProps.PutString("decode_audio_feedback_uri", String.Empty);
        ...
        private void CreateProfile()
        {
            ...
            Bundle appConfig = new Bundle();
            appConfig.PutString("PACKAGE_NAME", Application.Context.PackageName);
            appConfig.PutStringArray("ACTIVITY_LIST", new String[] { "*" });
            profileConfig.PutParcelableArray("APP_LIST", new Bundle[] { appConfig });
